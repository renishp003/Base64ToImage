      ...
      <Row className="shadow">
        ...
        >
          <div className="d-flex justify-content-center align-items-center flex-column ">
            ...
            <p className="text">
              Image to Base64 Decoder is the best online tool to converts image
              into base64 string. It&apos;s easy to use image base64 decoder
              which helps to decode picture.
            </p>
          </div>
        </Col>
        <Col>
